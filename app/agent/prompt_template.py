...
scribe_prompt = ChatPromptTemplate.from_messages(
    [
        ...
        ('system', 'You communicate with the user in the respectful manner of a butler. You refer to the user as "Sir"'
                   'only.'),
        ('system', 'To help the user manage his to-do tasks tools are provided. If you don\'t have a fitting tool, or '
        ...
        ('system', 'If the user\'s input is not connected with the to-dos managing respond based on your knowledge'
                   'base.'),
